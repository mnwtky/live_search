class EventsController < ApplicationController
  ...
  def event_params
    params.require(:event).permit(:image, :title, :price, :address, :event_date, :opening_time, :start_time, :end_time,
                                  :ticket_reservation, :info, :area_id, :genre_id).merge(user_id: current_user.id)
  end
